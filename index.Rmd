...
author: Zixuan Chen
subtitle: Subtitle here if desired you can delete this line
---

# Introduction

The precipitation is the most important data in the hydrology modeling. Analysis the precipitation data could improve the model. In this project, the interactive map could show the distribution of precipitation in the New York State. All the data is from the USGS, there are 35 stations were used in the project. The interactive map could indicate the mean, maximum, and minimum precipitation for each station. Also, the time series plots could illustrate the trend of the precipitation. transform the data to daily points.
The processes are descried in following steps. Your introduction is written like you still don't know if the results are correct or if there are better way to perform the same thing while your results are clearly amazing. So you could review your formulation.


* Download the data from the URL of USGS directly. Great decribtion of the data you used but this cold be in Materials and Method section.
* Data cleaning.
...
All sources are cited in a consistent manner Do not forget sources
